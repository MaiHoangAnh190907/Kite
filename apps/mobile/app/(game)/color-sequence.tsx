...
export default function ColorSequenceScreen(): React.JSX.Element {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (remaining <= 0) {
        ...
        setPhase('done');
        recordEvents('color_sequence', eventsRef.current);
        endGame('color_sequence');
        setShowEndAnim(true);
